...
const models: TsoaRoute.Models = {
    ...
    "Omit_Client.id_": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_Client.Exclude_keyofClient.id__","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "ClientCreate": {
        "dataType": "refAlias",
        "type": {"ref":"Omit_Client.id_","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/clients',
            ...
            ...(fetchMiddlewares<RequestHandler>(ClientController.prototype.listClients)),
            ...
            try {
              ...
              const promise = controller.listClients.apply(controller, validatedArgs as any);
        ...
        app.post('/clients',
            ...
            function ClientController_createClient(request: any, response: any, next: any) {
            const args = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"ClientCreate"},
            };
        ...
        app.get('/clients/:clientId',
            ...(fetchMiddlewares<RequestHandler>(ClientController)),
            ...(fetchMiddlewares<RequestHandler>(ClientController.prototype.getClient)),

            function ClientController_getClient(request: any, response: any, next: any) {
            const args = {
                    clientId: {"in":"path","name":"clientId","required":true,"dataType":"double"},
            };
        ...
        app.put('/clients/:clientId',
            ...(fetchMiddlewares<RequestHandler>(ClientController)),
            ...(fetchMiddlewares<RequestHandler>(ClientController.prototype.updateClient)),

            function ClientController_updateClient(request: any, response: any, next: any) {
            const args = {
                    clientId: {"in":"path","name":"clientId","required":true,"dataType":"double"},
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"ClientUpdate"},
            };
        ...
        app.delete('/clients/:clientId',
            ...(fetchMiddlewares<RequestHandler>(ClientController)),
            ...(fetchMiddlewares<RequestHandler>(ClientController.prototype.deleteClient)),

            function ClientController_deleteClient(request: any, response: any, next: any) {
            const args = {
                    clientId: {"in":"path","name":"clientId","required":true,"dataType":"double"},
            };
